...
static int (*array_mobility_function_duration[NUM_MOBILITY_FUNCTIONS])
                                    (const char*, int (*ptr_func)()) = {
    random_way_point_duration,
    direct_way_point_duration
};

static struct vec2 (*array_mobility_function_target_pos[NUM_MOBILITY_FUNCTIONS])
                                    (const char*, int (*ptr_func)()) = {
